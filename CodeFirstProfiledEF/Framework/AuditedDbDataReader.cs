...
namespace CodeFirstProfiledEF.Framework
{
    public class AuditedDbDataReader : DbDataReader
    {
        ...
        {
            // this can occur when we're not auditing, but we've inherited from AuditedDbCommand and are returned 
        ...
        {
            return ((IEnumerable)_reader).GetEnumerator();
        }
